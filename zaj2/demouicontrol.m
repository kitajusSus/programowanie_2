...
function update_plot(obj,init=false)
  h=guidata(obj);  # pobieranie danych obiektu
  replot=false;
  recalc=false;
  switch (gcbo)  # Get Callback Object - zwraca uchwyt obiektu wywolujacego funkcje zwrotna callback
  ...
  if (replot)
    ...
    set(h.plot,"color",merge(cb_red,[1 0 0 ],[0 0 1]),"linestyle",lstyle,
        "marker", mstyle);
  endif
endfunction
